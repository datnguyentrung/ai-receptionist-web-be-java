...
class ErrorCodeContractTest {
    ...
    void publicErrorCodeStatusContractDoesNotDrift() {
        Map<String, Integer> expectedStatuses = Map.ofEntries(
                ...
                Map.entry("POSITION_NOT_FOUND", 404),
                Map.entry("PERSON_NOT_FOUND", 404),
                Map.entry("USER_PERSON_NOT_FOUND", 404),
                Map.entry("POSITION_CODE_ALREADY_EXISTS", 409),
                ...
                Map.entry("SESSION_ATTENDANCE_NOT_FOUND", 404),
                ...
                Map.entry("SESSION_ATTENDANCE_PARTICIPANT_INVALID", 400),
